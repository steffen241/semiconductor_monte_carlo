# -*- coding: utf-8 -*-
"""
Created on Fri Jun 27 13:41:16 2014
...
f = h5py.File('InAlAs/Temperature/scat_300K.h5','r')
...
fig.show()
fig.savefig('Scattering_rate_inalas_G.pdf',dpi=300)
...
fig.show()
fig.savefig('Scattering_rate_inalas_L.pdf',dpi=300)
...
fig.show()
fig.savefig('Scattering_rate_inalas_X.pdf',dpi=300)