...
def calc_fft(time,data,N):
    ...
    fft_data = pl.fft(data*1)/N#,n=N)/N#/N #sqrt(N) #(4*4096) ss.blackman(size(data))
    fft_data = 2*fft_data[:N/2]
...
wp_ingaas_1e16 = get_plasma('ingaas_1e16.h5')
wp_ingaas_1e17 = get_plasma('ingaas_1e17.h5')
wp_ingaas_1e18 = get_plasma('ingaas_1e18.h5')
wp_inalas_1e16 = get_plasma('inalas_1e16.h5')
wp_inalas_1e17 = get_plasma('inalas_1e17.h5')
wp_inalas_1e18 = get_plasma('inalas_1e18.h5')

fig = plt.figure(2)
wp = fig.add_subplot(111)
wp.loglog(dop,p_freq[0,:]/1e12,label='InGaAs')
wp.loglog(dop,p_freq[1,:]/1e12,label='InAlAs')
wp.errorbar(1e16,wp_ingaas_1e16[1],yerr=abs(wp_ingaas_1e16[2]),fmt='o',color='black',ecolor='b', capthick=2)
wp.errorbar(1e17,wp_ingaas_1e17[1],yerr=abs(wp_ingaas_1e17[2]),fmt='o',color='black',ecolor='b', capthick=2)
wp.errorbar(1e18,wp_ingaas_1e18[1],yerr=abs(wp_ingaas_1e18[2]),fmt='o',color='black',ecolor='b', capthick=2)
wp.errorbar(1e16,wp_inalas_1e16[1],yerr=abs(wp_inalas_1e16[2]),fmt='o',color='black',ecolor='b', capthick=2)
wp.errorbar(1e17,wp_inalas_1e17[1],yerr=abs(wp_inalas_1e17[2]),fmt='o',color='black',ecolor='b', capthick=2)
wp.errorbar(1e18,wp_inalas_1e18[1],yerr=abs(wp_inalas_1e18[2]),fmt='o',color='black',ecolor='b', capthick=2)
